    ...
    <script type="module">
        ...
        const DEFAULT_STATE = {
            ...
            bouquets: [
                ...
                { id: '2', name: 'Morning Dew', description: 'Fresh white lilies and soft pink tulips.', images: ['https://images.unsplash.com/photo-1526047932273-341f2a7631f9?auto=format&fit=crop&w=800&q=80'], bestseller: false, visible: true, currentPrice: '850', position: 2 }
            ],
            reviews: [
        ...
        // Load local cache immediately for zero-lag 1-second display
        ...
        onValue(dataRef, (snapshot) => {
            ...
            if (val) {
                ...
                // Re-render immediately on live admin changes
                renderHome();
            }
        }, (err) => {
        ...
        window.orderViaWhatsApp = function(bouquetId, event) {
            ...
            if (bouquet.images && bouquet.images[0]) {
                try {
                    ...
                    console.error('Auto-download bouquet image:', err);
                }
            }
