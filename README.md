...
<body class="text-gray-800 antialiased selection:bg-[#10583f] selection:text-white">
    ...
    <script type="module">
        ...
        // Updated Firebase Configuration for Backup Backend
        ...
        // Ultra-fast rendering: Load local cache immediately for 1-second display
        ...
        window.renderBouquetGridHTML = function(displayedBouquets) {
            if (displayedBouquets.length === 0) {
                return `
                    <div class="text-center py-20 luxury-card rounded-[2rem] animate-fade-up w-full col-span-full">
            ...
            return `
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 md:gap-x-10 gap-y-8 sm:gap-y-10 md:gap-y-16 w-full">
        ...
        window.renderHome = function() {
            ...
            container.innerHTML = `
                ...
                <section class="px-6 py-12 sm:py-20 max-w-7xl mx-auto min-h-[50vh] flex flex-col items-center">
                    <div id="bouquet-grid-wrapper" class="w-full">
